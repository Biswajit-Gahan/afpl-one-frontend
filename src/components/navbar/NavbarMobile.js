...
import { AuthLabel, ButtonContainer, Container, CustomIcon, HeaderLabel, LanguageList, LanguageListContainer, LeftContainer, Logo, LogoContainer, LogoLeft, LogoRight, NavList, NavListContainer, RightContainer, UserContainer } from './navbar.mobile.styles';
    ...
    <Container>
      <LeftContainer>
        <LogoContainer>
          ...
          <LogoRight><AiOutlineCloseCircle /></LogoRight>
        </LogoContainer>
        <NavListContainer>
